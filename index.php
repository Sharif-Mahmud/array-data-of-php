                ...
                <div class="row">
                  <div class="col-md-5">
                    <div class="detail-box">
                      ...
                      <div class="btn-box">
                        <a href="<?php echo $slide["buttons"]["btn1"]["link"] ?>" class="btn1">
                          <?php echo $slide["buttons"]["btn1"]["title"] ?>
                        </a>
                        <a href="<?php echo $slide["buttons"]["btn2"]["link"] ?>" class="btn2">
                          <?php echo $slide["buttons"]["btn2"]["title"] ?>
                        </a>
                      </div>
                    </div>
                  </div>
  ...
  <section class="furniture_section layout_padding">
    <div class="container">
      <div class="heading_container">
        ...
        <p>
          <?php echo $furniture["subtitle"] ?>
        </p>
      </div>
      <div class="row">

        <?php foreach ($furniture["products"] as $item): ?>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <a style="background-color:<?php echo $about['button']['bg_color'] ?>" href="">
